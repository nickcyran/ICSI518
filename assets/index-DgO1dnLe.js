...
#define LOW_PRECISION`),e}const lb={[Pc]:"SHADOWMAP_TYPE_PCF",[Ho]:"SHADOWMAP_TYPE_VSM"};function cb(o){return lb[o.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const ub={[Ns]:"ENVMAP_TYPE_CUBE",[Or]:"ENVMAP_TYPE_CUBE",[Xc]:"ENVMAP_TYPE_CUBE_UV"};function fb(o){return o.envMap===!1?"ENVMAP_TYPE_CUBE":ub[o.envMapMode]||"ENVMAP_TYPE_CUBE"}const db={[Or]:"ENVMAP_MODE_REFRACTION"};function hb(o){return o.envMap===!1?"ENVMAP_MODE_REFLECTION":db[o.envMapMode]||"ENVMAP_MODE_REFLECTION"}const pb={[w_]:"ENVMAP_BLENDING_MULTIPLY",[JS]:"ENVMAP_BLENDING_MIX",[$S]:"ENVMAP_BLENDING_ADD"};function mb(o){return o.envMap===!1?"ENVMAP_BLENDING_NONE":pb[o.combine]||"ENVMAP_BLENDING_NONE"}function gb(o){const e=o.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,s=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:s,maxMip:i}}function _b(o,e,i,s){const l=o.getContext(),u=i.defines;let d=i.vertexShader,p=i.fragmentShader;const m=cb(i),h=fb(i),v=hb(i),x=mb(i),_=gb(i),y=tb(i),T=eb(u),C=l.createProgram();let M,S,w=i.glslVersion?"#version "+i.glslVersion+`
